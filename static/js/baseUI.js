...
export function renderRightSideLogged(rightSide) {
    ...
    dropdown.innerHTML = `
        <button class="dropdown__button dropdown__button--nav" aria-expanded="false">
            <span id="username">Menu</span>
            <svg class="dropdown__button__arrow" xmlns="http://www.w3.org/2000/svg" width="200" height="200" 
        ...
        <ul class="dropdown__menu dropdown__menu--nav">
            <li>
                <a href="/profile">
                    <svg class="dropdown__menu__icon" xmlns="http://www.w3.org/2000/svg" width="200" height="200" 
